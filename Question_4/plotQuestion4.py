...
def main(argv):
    ...
    month = csv_filename.split(".")
    title = "Total Number of Cases VS The Number of Hospitalizations in The Month of "+ month[0]
    plt.title(title, fontsize = 50)
    sns.lineplot(x = "Date", y = "Total Number Of Cases", hue="Case Type", data=csv_df)

    plt.xlabel("Date", size = 30, labelpad=40)
    plt.ylabel("Total Number Of Cases", size = 30, labelpad=40)
